...
import { inserirPessoa, listarPessoas } from "../infra/pessoas";
      ...
      <div>
        ...
        <ul>
          {pessoas.map((pessoa) => {
            return (
              <li key={pessoa.id}>
                <strong>Nome: </strong>{pessoa.nome} - <strong>E-mail: </strong>{pessoa.email} - <strong>Telefone: </strong>{pessoa.telefone}
              </li>
            )
          })}
        </ul>
